...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        //echo var_dump($row);
        $serialNumber = $row['serialno']; // Assuming 'Sr no.' is the column name for serial number
        ...
        echo "<script>alert('Invalid admin name or password. Please register first.')</script>";
