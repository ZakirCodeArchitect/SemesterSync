...
<body>
    <div class="container">
        ...
        <main>
            ...
            <h2 style="margin-left: 10px;">Assignments Alerts</h2>
            <!-- Analyses -->
            <div class="analyse">
                <div class="sales">
                    <div class="status">
                        <a href="assignments.php">
                            <div class="info">
                                ...
                                <h3>WAD Assignment Added</h3>
                                <h7 style="margin-left: 10px;">Due May 9 </h7>
                                <!-- <h9 style="margin-left: 16px;">CS324-WAD | Assignment</h7> -->
                            </div>
                        </a>
                    ...
                    <div class="status">
                        <a href="assignments.php">
                            <div class="info">
                                ...
                                <h3>ADA Assignment Added</h3>
                                <h7 style="margin-left: 10px;">Due May 14 </h7>
                                <!-- <h9 style="margin-left: 16px;">CS324-WAD | Assignment</h7> -->
                            </div>
                        </a>
        ...
        <div class="right-section">
            ...
            <div class="reminders">
                ...
                <div class="notification">
                    ...
                    <div class="content">
                        <div class="info">
                            <h3>WAD Assignment# 4 </h3>
                            <small class="text_muted">
                                Deadline extented till 9th-May
                            </small>
                        </div>
                        <span class="material-icons-sharp">
                            more_vert
